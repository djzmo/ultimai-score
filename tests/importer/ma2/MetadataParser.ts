...
describe('ma2 metadata parser', () => {
    it('should parse metadata correctly', async () => {
        ...
        expect(notesDataPath.get(MusicNotesDifficulty.BASIC)).toBe('011999_00.ma2');
        expect(notesDataPath.get(MusicNotesDifficulty.ADVANCED)).toBe('011999_01.ma2');
        expect(notesDataPath.get(MusicNotesDifficulty.EXPERT)).toBe('011999_02.ma2');
        expect(notesDataPath.get(MusicNotesDifficulty.MASTER)).toBe('011999_03.ma2');
        expect(notesDataPath.get(MusicNotesDifficulty.RE_MASTER)).toBe('011999_04.ma2');
